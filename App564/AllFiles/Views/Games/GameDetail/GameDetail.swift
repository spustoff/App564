            ...
            VStack {
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ...
                    VStack(spacing: 15) {
                        ...
                        Text(viewModel.selectedGame?.gDescription ?? "")
                            .foregroundColor(.gray)
                            .font(.system(size: 14, weight: .regular))
                            .padding()
                            .frame(maxWidth: .infinity, alignment: .leading)
                    ...
                    .background(RoundedRectangle(cornerRadius: 10).fill(.white))
                            ...
                            Text(viewModel.selectedGame?.gRules ?? "")
                                .foregroundColor(.gray)
                                .font(.system(size: 14, weight: .regular))
                                .padding()
                                .frame(maxWidth: .infinity, alignment: .leading)
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            viewModel.prCurGame = viewModel.selectedGame?.gName ?? ""
...
#Preview {
    GameDetail(viewModel: GamesViewModel())
}
